        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    <!-- item-->
                    <a href="his_admin_manage_employee.php" class="dropdown-item">
                        <i class="fe-users mr-1"></i>
                        <span>Employee</span>
                    </a>

                    <!-- item-->
                    <a href="his_admin_manage_patient.php" class="dropdown-item">
                        <i class="fe-activity mr-1"></i>
                        <span>Patient</span>
                    </a>

                    <!-- item-->
                    <a href="his_admin_view_patients.php" class="dropdown-item">
